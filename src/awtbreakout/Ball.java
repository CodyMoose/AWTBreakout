...
public class Ball extends JFrame
{
    ...
    /**
     * Boolean that indicates whether or not the last paddle hit was Player 1's paddle. Used for determining horizontal component of direction
     */
    ...
    /**
     * Angle from which the ball will reflect off of the paddle. Always reflects from paddle back towards center of boundary
     */
    public double             reflectionAngle  = 0;
    /**
     * True X coordinate of ball. Used for accuracy, because otherwise ball would not move, because floats often round down when parsed to integers
     */
    public double             trueX            = 800;
    /**
     * True Y coordinate of ball. Used for accuracy, because otherwise ball would not move, because floats often round down when parsed to integers
     */
     ...
     */
    public static final RadialGradientPaint GREEN_MAGENTA = new RadialGradientPaint(25, 25, 25, GRADIENT_FLOATS, G_M_GRADIENT_COLORS);
    /**
     * Radial gradient of blue in the middle, yellow on the outside
     */
    public static final RadialGradientPaint BLUE_YELLOW = new RadialGradientPaint(25, 25, 25, GRADIENT_FLOATS, B_Y_GRADIENT_COLORS);
    /**
     * Boolean used to determine which gradient is currently being used to paint the ball
     */
    ...
    public Ball()
    {
        ...
        deltaY = (Math.random() - 0.5) > 1 ? ScoreWindow.speedMultiplier : -1 * ScoreWindow.speedMultiplier;
        setSize(50,50);
     ...
     * @param X x-coordinate for ball to be moved to
     */
     ...
     * @param Y y-coordinate for ball to be moved to
     */
     ...
     * @param X x-coordinate for upper left corner of ball
     * @param Y x-coordinate for upper left corner of ball
     */
    ...
    /**
     * Sets location of upper left corner of ball
     * @param d dimension of ball in (X, Y) format
     */
    ...
    /**
     * Sets information about position of ball, such as top, bottom, and middle y-coordinates, and left and right x-coordinates
     */
     ...
     * @param X x-coordinate for the center of the ball to be moved to
     * @param Y y-coordinate for the center of the ball to be moved to
     */
